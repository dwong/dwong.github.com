...
task :generate do
  ...
  system "cat #{source_dir}/javascripts/jquery.js >> #{source_dir}/javascripts/all.js"
  system "cat #{source_dir}/javascripts/galleria/galleria-1.2.8.min.js >> #{source_dir}/javascripts/all.js"
