...
task :generate do
  ...
  system "echo \"\n\" >> #{source_dir}/javascripts/all.js"
  system "cat #{source_dir}/javascripts/jquery.min.js > #{source_dir}/javascripts/jquery.js"
  system "echo \"\n\" >> #{source_dir}/javascripts/jquery.js"
  system "cat #{source_dir}/javascripts/galleria/galleria-1.2.8.min.js >> #{source_dir}/javascripts/jquery.js"
  system "echo \"\n\" >> #{source_dir}/javascripts/jquery.js"
  system "cat #{source_dir}/javascripts/init_galleria.js >> #{source_dir}/javascripts/jquery.js"
