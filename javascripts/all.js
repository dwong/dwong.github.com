...
jQuery(document).ready(function(){
  if(!jQuery('body').hasClass('no-sidebar')){
  	var a=jQuery.cookie("sidebar_collapsed",{raw:true});if(a==="1"){jQuery("body").addClass("collapse-sidebar")}else{jQuery("body").removeClass("collapse-sidebar")}
  }
